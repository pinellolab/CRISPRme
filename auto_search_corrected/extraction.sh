...
# LC_ALL=C sort -T $dir -u ref.chr_pos.txt > ref.chr_pos.sort.txt 
...
# LC_ALL=C sort -T $dir -u semi_common.chr_pos.txt > semi_common.chr_pos.sort.txt
# LC_ALL=C fgrep -f semi_common.chr_pos.sort.txt  $1 >> $3.semi_common_targets.txt
# LC_ALL=C sort -T $dir -u $3.semi_common_targets.txt > semi_common_targets.sort.txt
